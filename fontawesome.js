...
var icons_Guardian200 = {
    ...
    fa_setting                      : "\u{2699}",
    fa_datalink                     : "\u{1F4E1}",
    fa_multilayers                  : "\u{2630}",
    fa_ok                           : "\u{2713}",
    fa_white_down_trinangle         : "\u{26DB}",
    fa_left_double_angle_bracket    : "\u{fe3d}",
    fa_right_double_angle_bracket   : "\u{fe3e}",
    fa_up_white_arrow_up            : "\u{21e7}",
    fa_up_white_arrow_down          : "\u{21e9}"
}
